...
begin
  ...
  //Встановлення розмірів панелей з рівнями залежно від висоти екрану
  d:=10;
 ...
 // DownPanel.Width:=w-40;
  ...
  //Розміщення картинки для малювання ліній сітки
  icw:=w-280;
  ich:=h-150;
...
// Перехід в головне меню з маленької картинки
